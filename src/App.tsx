...
import TelegramDuckGif from './images/telegram-duck-unscreen.gif';
import {
  binanceLogo,
  dailyCipher,
  dailyCombo,
...
const App: React.FC = () => {
  ...
  const [points, setPoints] = useState(
    0 || JSON.parse(localStorage.getItem("points"))
  );
            ...
            <div className="w-full bg-black text-white h-screen font-bold flex flex-col max-w-xl">
              <div className="px-4 z-10">
                <div className="flex items-center space-x-2 pt-4">
                  ...
                  <div>
                    <p className="text-sm">Akbar (CEO)</p>
                  </div>
                </div>
        ...
        element={
          <div className="bg-black flex justify-center">
            <div className="w-full bg-black text-white h-screen font-bold flex flex-col max-w-xl">
              ...
              <div className="flex-grow mt-4 bg-[#f3ba2f] rounded-t-[48px] relative top-glow z-0">
                <div className="absolute top-[2px] left-0 right-0 bottom-0 bg-[#1d2025] rounded-t-[46px]">
                  <div className="w-full flex items-center justify-center flex-col m-auto mt-10">
                    <img
                      src={TelegramDuckGif}
                      alt="TelegramDuckGif"
                      className="m-auto w-36"
                    />
                    <p className="m-auto text-center p-2">
                      Akbar tomonidan tuzatilish ishlari olib borilmoqda...{" "}
                    </p>
                  </div>
                </div>
              </div>
